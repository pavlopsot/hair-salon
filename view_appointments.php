...
if ($result->num_rows > 0) {
    echo "<table border='1'><tr><th>Όνομα</th><th>Τηλέφωνο</th><th>Ημερομηνία</th><th>Ώρα</th></tr>";
    while ($row = $result->fetch_assoc()) {
        echo "<tr><td>".$row["name"]."</td><td>".$row["phone"]."</td><td>".$row["date"]."</td><td>".$row["time"]."</td></tr>";
    }
    echo "</table>";
} else {
